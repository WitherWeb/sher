...
document.addEventListener("DOMContentLoaded", () => {
  let swiperPortfolio = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]("[data-portfolio-swiper]", {
    loop: true,
    slidesPerView: 'auto',
    freeMode: true,
    navigation: {
      nextEl: '.portfolio__swiper-navigation-next',
      prevEl: '.portfolio__swiper-navigation-prev'
    },
    scrollbar: {
      el: '.portfolio__swiper-scroll',
      // Добавляем полосу прокрутки
      draggable: true // Возможность перетаскивать полосу прокрутки
    },
  ...
  let swiperBarbershops = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]("[data-barbershops-swiper]", {
    loop: true,
    slidesPerView: 4,
    freeMode: true,
    spaceBetween: 20,
    navigation: {
      nextEl: '.barbershops__swiper-navigation-next',
      prevEl: '.barbershops__swiper-navigation-prev'
    },
    scrollbar: {
      el: '.barbershops__swiper-scroll',
      // Добавляем полосу прокрутки
      draggable: true // Возможность перетаскивать полосу прокрутки
    },
  ...
  function updatePagination(swiper) {
    ...
    const progress = swiper.progress; // Прогресс прокрутки (от 0 до 1)
    const currentSlideIndex = Math.round(progress * (totalSlides - 1)) + 1; // Текущий слайд
    const paginationElement = document.querySelector('.reviews__swiper-pagination');
    paginationElement.textContent = `${currentSlideIndex}/${totalSlides}`;
  }
  let swiperReviews = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]("[data-reviews-swiper]", {
    slidesPerView: "auto",
    freeMode: true,
    spaceBetween: 20,
    navigation: {
    ...
    on: {
      init: function () {
        updatePagination(this); // Обновить пагинацию при инициализации
      },

      slideChangeTransitionEnd: function () {
        updatePagination(this); // Обновить пагинацию после завершения анимации перехода
      }
    }
    // breakpoints: {
    //   // when window width is >= 480px
  ...
  let swiperAboutPhotos = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]("[data-about-photos-swiper]", {
    loop: true,
    navigation: {
      nextEl: '.about-photos__swiper-navigation-next',
      prevEl: '.about-photos__swiper-navigation-prev'
    },
    scrollbar: {
      el: '.about-photos__swiper-scroll',
      // Добавляем полосу прокрутки
      draggable: true // Возможность перетаскивать полосу прокрутки
    },
  ...
  let swiperPhotos = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]("[data-photos-swiper]", {
    navigation: {
      nextEl: '.about-photos__swiper-navigation-next',
      prevEl: '.about-photos__swiper-navigation-prev'
    },
  ...
  if (document.querySelector(".hero__img")) {
    const heroVideo = document.querySelectorAll(".hero__img");
    const hero = document.querySelector(".hero");
    heroVideo.forEach(el => {
      el.style.height = `${hero.offsetHeight}px`;
    });
